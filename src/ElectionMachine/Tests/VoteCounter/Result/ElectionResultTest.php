...
namespace mespinosaz\ElectionMachine\Tests\VoteCounter\Result;
...
class ElectionResultTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('mespinosaz\ElectionMachine\VoteCounter\Result\ElectionResult', $this->result);
    }
